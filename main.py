...
def refresh():
    ...
    if len(discover_bulbss)==3:
        bulb0=Bulb(discover_bulbss[0].get('ip'))
        bulb0_name=(discover_bulbss[0].get('capabilities')).get('name')
        bulb1=Bulb(discover_bulbss[1].get('ip'))
        bulb1_name=(discover_bulbss[1].get('capabilities')).get('name')
        bulb2=Bulb(discover_bulbss[2].get('ip'))
        bulb2_name=(discover_bulbss[2].get('capabilities')).get('name')
        listbox.insert(1,bulb0_name)
        listbox.insert(2,bulb1_name)
        listbox.insert(3,bulb2_name)

    if len(discover_bulbss)==4:
        bulb0=Bulb(discover_bulbss[0].get('ip'))
        bulb0_name=(discover_bulbss[0].get('capabilities')).get('name')
        bulb1=Bulb(discover_bulbss[1].get('ip'))
        bulb1_name=(discover_bulbss[1].get('capabilities')).get('name')
        bulb2=Bulb(discover_bulbss[2].get('ip'))
        bulb2_name=(discover_bulbss[2].get('capabilities')).get('name')
        bulb3=Bulb(discover_bulbss[3].get('ip'))
        bulb3_name=(discover_bulbss[3].get('capabilities')).get('name')
        listbox.insert(1,bulb0_name)
        listbox.insert(2,bulb1_name)
        listbox.insert(3,bulb2_name)
        listbox.insert(4,bulb3_name)

    if len(discover_bulbss)==5:
        bulb0=Bulb(discover_bulbss[0].get('ip'))
        bulb0_name=(discover_bulbss[0].get('capabilities')).get('name')
        bulb1=Bulb(discover_bulbss[1].get('ip'))
        bulb1_name=(discover_bulbss[1].get('capabilities')).get('name')
        ...
        bulb3=Bulb(discover_bulbss[3].get('ip'))
        bulb3_name=(discover_bulbss[3].get('capabilities')).get('name')
        bulb4=Bulb(discover_bulbss[4].get('ip'))
        bulb4_name=(discover_bulbss[4].get('capabilities')).get('name')
        listbox.insert(1,bulb0_name)
        listbox.insert(2,bulb1_name)
        listbox.insert(3,bulb2_name)
